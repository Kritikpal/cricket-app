...
public class Teams {
    ...
    // Playing XI Lists
    public static List<Player> rcbPlayingXI = Arrays.asList(
    ...
    public static List<Player> cskPlayingXI = Arrays.asList(
    ...
    // Team Objects
    public static Team rcbTeam = new Team(1L, "RCB", rcbPlayingXI);
    public static Team cskTeam = new Team(2L, "CSK", cskPlayingXI);
}
